...
let snake1 = initSnake("./assets/headsnake.webp","./assets/body.jpg");
    ...
    if(snake.level == 2){
        ...
        if ((snake.head.x == (dinding.position.x+i) && snake.head.y == dinding.position.y) || (snake.head.x == (dinding.position.x+i) && snake.head.y == (dinding.position.y+5)) && dinding.status == true){
          ...
          for(let i = 0; i <= 15; i++){
            ...
            for(let i = 0; i <= 15; i++){
              if ((snake.head.x == (dinding.position.x+i) && snake.head.y == dinding.position.y)|| (snake.head.x == (dinding.position.x+14) && snake.head.y == (dinding.position.y+i))  && dinding.status == true){
                for(let j = 1; j < snake.body.length; j++){
                snake.body.pop()
                if(snake.body.length > 1){
                  snake.body.pop() 
...
function checkCollision(snakes) {
    ...
    if (isCollide) {
        ...
        alert("Game over");
        snake1 = initSnake("./assets/headsnake.webp","./assets/body.jpg");
        return isCollide;
    } else if(isWin){
        alert("You Winner");
        snake1 = initSnake("./assets/headsnake.webp","./assets/body.jpg");
